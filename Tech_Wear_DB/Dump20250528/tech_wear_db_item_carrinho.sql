...
CREATE TABLE `item_carrinho` (
  ...
  `quantidade` int(10) unsigned zerofill DEFAULT NULL,
  `carrinho_id_carrinho` int NOT NULL,
  PRIMARY KEY (`id_item_carrinho`,`produtos_id_produtos`,`carrinho_id_carrinho`),
  UNIQUE KEY `iditem_carrinho_UNIQUE` (`id_item_carrinho`),
  KEY `fk_item_carrinho_produtos1_idx` (`produtos_id_produtos`),
  KEY `fk_item_carrinho_carrinho1_idx` (`carrinho_id_carrinho`),
  CONSTRAINT `fk_item_carrinho_produtos1` FOREIGN KEY (`produtos_id_produtos`) REFERENCES `produtos` (`id_produtos`)
